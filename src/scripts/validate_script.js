...
function Maskedinput(){
    if($('.el-input[name="phone"]')){
        $('.el-input[name="phone"]').mask('+38 099 999 99 99');
    }
}
...
$(document).ready(function(){
   ...
   validate('.main-form', {submitFunction:validationCall});
   validate('.consult-form', {submitFunction:validationCall});
